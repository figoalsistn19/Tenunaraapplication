package com.example.tenunaraapplication.main.ui.ui.camera

import android.graphics.RectF
import org.tensorflow.lite.Interpreter
import org.tensorflow.lite.support.image.TensorImage

class CameraHelper(private val tflite: Interpreter, private val labels: List<String>) {
    ...
    private val predictions get() = (0 until OBJECT_COUNT).map { it ->
        ObjectPrediction(
